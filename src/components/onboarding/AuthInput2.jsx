...
const AuthInput2 = ({ state, setState, text, type, error, placeholder }) => {
  ...
  return (
    <div className="w-full h-auto flex   flex-col gap-1 justify-start items-start  ">
      ...
      <div
        className={`w-full h-[52px] lg:w-[434px] focus-within:border-[1px] focus-within:border-[#55C9FA] rounded-[12px] bg-[##001229] flex items-center justify-start  ${
          error && "error"
        } `}
      >
        <div
