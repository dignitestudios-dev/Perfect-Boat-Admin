...
const OwnerDelete = () => {
  return (
    ...
    <div className="grid grid-cols-[1fr_1fr_2fr_1.5fr_1.5fr_1fr_0.5fr] gap-4  p-4 text-[#FFFFFF80] text-[12px] font-semibold">
      {[
        "Owner Name",
        "Total No. of Users",
        "Email",
    ...
    {Array.from({ length: 13 })?.map((_, index) => (
      <div
        key={index}
        className="grid grid-cols-[1fr_1fr_2fr_1.5fr_1.5fr_1fr_0.5fr] gap-4 p-4 text-white text-[12px] border-b border-[#FFFFFF24]"
      >
        {[
          "Owner ABC",
          "156",
