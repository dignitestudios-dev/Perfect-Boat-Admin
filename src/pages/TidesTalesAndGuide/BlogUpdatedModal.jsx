...
const BlogUpdatedModal = ({ isOpen, setIsOpen }) => {
  ...
  return (
    ...
    >
      <div
        ref={modalRef}
        className="relative bg-[#02203A] w-[418px] h-[270px] flex flex-col gap-5 justify-start items-center p-8 shadow-lg rounded-lg    "
      >
        {/* Close button */}
        <button
          onClick={closeModal}
        ...
        <div className="w-auto flex flex-col justify-center items-center gap-3">
          <div className="w-full h-auto flex flex-col justify-center items-center gap-1">
            ...
            Smooth sailing! Your changes have been successfully updated. Your refreshed blog is now ready to continue its voyage. Happy Writing.            </span>
          </div>
        </div>
      </div>
    </div>
...
export default BlogUpdatedModal;
